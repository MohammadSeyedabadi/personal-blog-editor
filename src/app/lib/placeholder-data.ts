...
const users = [
  {
    ...
    name: "Mohammad",
    email: "mhmd.sey.7@gmail.com",
    password: "md.sey.7@gmPASS123",
  },
];
...
const enPosts = [
  {
    ...
    faFormattedCreatedAt: "۲۹ اردیبهشت ۱۴۰۴",
    faFormattedCreatedAtMonthDay: "۲۹ اردیبهشت",
    year: "2025",
    faYear: "1404",
    formattedLastModified: "May 19, 2025",
    faFormattedLastModified: "۲۹ اردیبهشت ۱۴۰۴",
  ...
  },
  {
    ...
    faFormattedCreatedAt: "۲۸ آبان ۱۴۰۲",
    faFormattedCreatedAtMonthDay: "۲۸ آبان",
    year: "2023",
    faYear: "1402",
    formattedLastModified: "November 19, 2023",
    faFormattedLastModified: "۲۸ آبان ۱۴۰۲",
    image:
      "/images/posts/how-to-create-a-multilevel-dropdown-menu-in-react/how-to-create-a-multilevel-dropdown-menu-in-react.png",
    excerpt:
    ...
    tags: ["front-end", "algorithm", "reactjs"],
    content:
...
const faPosts = [
  ...
  },
  {
    ...
    image:
      "/images/posts/how-to-create-a-multilevel-dropdown-menu-in-react/how-to-create-a-multilevel-dropdown-menu-in-react.png",
    excerpt:
      "منوهای کشویی چند سطحی جزء اصلی طراحی وب هستند. آنها با توانایی ارائه چندین گزینه برای انتخاب، نوارهای ناوبری را پویا و سازماندهی می کنند.",
...
export { users, customers, invoices, revenue, enPosts, faPosts };
